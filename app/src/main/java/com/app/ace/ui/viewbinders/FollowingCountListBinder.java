...
public class FollowingCountListBinder extends ViewBinder<FollowingCountDataItem> {
    private ImageLoader imageLoader;

    DockActivity context;
    public FollowingCountListBinder(DockActivity context) {
        super(R.layout.following_count_listitem);
    ...
    public ViewBinder.BaseViewHolder createViewHolder(View view) {
        return new FollowingCountListBinder.ViewHolder(view);
    }

    @Override
    public void bindView(final FollowingCountDataItem entity, int position, int grpPosition, View view, Activity activity) {

        FollowingCountListBinder.ViewHolder viewHolder = (FollowingCountListBinder.ViewHolder) view.getTag();
    ...
    public static class ViewHolder extends BaseViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            userImage = (CircleImageView) view.findViewById(R.id.userImageFollowing);
            txtUserName = (AnyTextView) view.findViewById(R.id.txtUserNameFollowing);
